 ...
 */
let firstName = "Sunaina"
let lastName = " Vallamkonda"
...
let newBest = 15125
let congratulations = "Congratulations \(fullName)! You beat you previous daily high score of \(previousBest) steps by walking \(newBest) steps yesterday!"
